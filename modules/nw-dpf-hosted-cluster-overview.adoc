...
Extracts the hosted cluster admin kubeconfig and stores it in the secret referenced by the `DPUCluster` custom resource, enabling the management cluster to communicate with the DPU hosted cluster.
