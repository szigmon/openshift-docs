...
[NOTE]
====
When you add worker nodes by using the Bare Metal Operator, CSRs are typically auto-approved.
Manual approval is required as a fallback if auto-approval is not functioning.
====
