...
$ helm upgrade --install dpu-worker-config \
    oci://quay.io/redhat-user-workloads/dpu-kit-for-nvidia-operator-tenant/dpu-worker-config-chart-4-22 \
