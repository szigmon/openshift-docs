...
[NOTE]
====
For jumbo frames, append `--set networkMTU=$NODES_MTU` (for example, `--set networkMTU=9000`) to match the MTU configured for the DPU network services.
Omit this flag when using the standard MTU of `1500`.
====
