...
|`DPFHCPPROVISIONER_PULL_SECRET_NAME`
...
|`DPFHCPPROVISIONER_SSH_SECRET_NAME`
...
$ export DPFHCPPROVISIONER_PULL_SECRET_NAME="my-pull-secret"
$ export OPENSHIFT_PULL_SECRET="/root/pull-secret.txt"
$ export DPFHCPPROVISIONER_SSH_SECRET_NAME="my-ssh-key"
